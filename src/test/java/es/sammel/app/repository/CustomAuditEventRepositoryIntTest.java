package es.sammel.app.repository;

import es.sammel.app.SammelApp;
import es.sammel.app.config.Constants;
import es.sammel.app.config.audit.AuditEventConverter;
import es.sammel.app.domain.PersistentAuditEvent;
...
import static es.sammel.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
